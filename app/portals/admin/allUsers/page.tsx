...
export default function AdminUsersPage() {
  ...
  }, [filters, loading]) // Only depend on filters and loading
  ...
  const handlePageChange = (newPage: number) => {
    ...
    // Fetch users after state update
    setTimeout(() => {
      fetchUsers()
    }, 0)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-slate-900 dark:to-gray-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card 
            className="bg-white dark:bg-gray-800 border-l-4 shadow-sm hover:shadow-md transition-all cursor-pointer hover:scale-105"
            style={{ borderLeftColor: KAZIPERT_COLORS.primary }}
          ...
          <Card 
            className="bg-white dark:bg-gray-800 border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-all cursor-pointer hover:scale-105"
            onClick={() => {
              setFilters(prev => ({ ...prev, role: 'EMPLOYER' }))
            }}
          >
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
          ...
          <Card 
            className="bg-white dark:bg-gray-800 border-l-4 border-l-green-500 shadow-sm hover:shadow-md transition-all cursor-pointer hover:scale-105"
            onClick={() => {
              setFilters(prev => ({ ...prev, role: 'EMPLOYEE' }))
            }}
          >
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
          ...
          <Card 
            className="bg-white dark:bg-gray-800 border-l-4 border-l-purple-500 shadow-sm hover:shadow-md transition-all cursor-pointer hover:scale-105"
            onClick={() => {
          ...
          <CardHeader>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <CardDescription>
                  {safePagination.total} users found • Page {safePagination.page} of {safePagination.pages}
                </CardDescription>
              </div>
              <div className="flex items-center gap-2">
            ...
            {safePagination.pages > 1 && (
              <div className="flex items-center justify-between mt-4">
                <div className="text-sm text-muted-foreground">
                  Showing {((safePagination.page - 1) * safePagination.limit) + 1} to {Math.min(safePagination.page * safePagination.limit, safePagination.total)} of {safePagination.total} users
                </div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <Badge>{selectedUser.stats?.jobsPosted || 0}</Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm">Applications</span>
                        <Badge>{selectedUser.stats?.applications || 0}</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
